...
export default function FavouritesPage() {
  ...
  const categories = ['all', ...Array.from(new Set(favouriteItems.map(item => item.category)))];
  const types = ['all', ...Array.from(new Set(favouriteItems.map(item => item.type)))];
  ...
  const shareItem = (item: FavouriteItem) => {
      ...
      <div className="flex-1 p-6">
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>{filteredItems.length} favourites found</span>
            </div>
            <div className="text-sm text-gray-600">
              Total: {favouriteItems.length} items
            </div>
          </div>
        </div>
        ...
        {filteredItems.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No favourites found</h3>
