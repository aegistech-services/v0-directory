...
// Mock billing data for public user
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">View your personal billing history and manage payments</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">RM 335.00</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">RM 79.00</div>
              <p className="text-xs text-muted-foreground">
                Due Dec 1, 2024
              </p>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-600">RM 29.00</div>
              <p className="text-xs text-muted-foreground">
                Basic Plan
              </p>
            </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your personal invoice and payment history</CardDescription>
          </CardHeader>
          <CardContent>
