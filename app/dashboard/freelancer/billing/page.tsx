...
// Mock billing data for freelancer
const mockBillingData = [
  {
    id: '1',
    invoiceNumber: 'INV-2024-001',
    description: 'Freelancer Service Listing',
    amount: 'RM 99.00',
    status: 'Paid',
    date: '2024-11-01',
    dueDate: '2024-12-01',
  ...
  },
  {
    ...
    description: 'Featured Service Promotion',
    amount: 'RM 59.00',
    status: 'Paid',
    date: '2024-10-15',
    dueDate: '2024-11-15',
  ...
  },
  {
    ...
    description: 'Portfolio Showcase Package',
    amount: 'RM 39.00',
    status: 'Paid',
    date: '2024-11-10',
    dueDate: '2024-11-10',
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Manage your service listings and subscription payments</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">RM 454.00</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">RM 99.00</div>
              <p className="text-xs text-muted-foreground">
                Due Dec 1, 2024
              </p>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-600">RM 59.00</div>
              <p className="text-xs text-muted-foreground">
                Featured Plan
              </p>
            </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your service listing and subscription payment history</CardDescription>
          </CardHeader>
          <CardContent>
