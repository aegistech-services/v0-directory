...
// Mock billing data for advertiser
const mockBillingData = [
  {
    id: '1',
    invoiceNumber: 'INV-2024-001',
    description: 'Premium Advertisement Campaign',
    amount: 'RM 299.00',
    status: 'Paid',
    date: '2024-11-01',
    dueDate: '2024-12-01',
    plan: 'Premium Ad Plan',
  ...
  },
  {
    ...
    description: 'Featured Banner Advertisement',
    amount: 'RM 159.00',
    status: 'Paid',
    date: '2024-10-15',
    dueDate: '2024-11-15',
    plan: 'Featured Ad Plan',
  ...
  },
  {
    ...
    description: 'Basic Advertisement Package',
    amount: 'RM 79.00',
    status: 'Paid',
    date: '2024-11-10',
    dueDate: '2024-11-10',
  ...
  },
  {
    ...
    description: 'Video Advertisement Package',
    amount: 'RM 199.00',
    status: 'Paid',
    date: '2024-11-20',
    dueDate: '2024-11-20',
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Manage your advertisement campaigns and payment history</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">RM 1,493.00</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">RM 299.00</div>
              <p className="text-xs text-muted-foreground">
                Due Dec 1, 2024
              </p>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-600">RM 159.00</div>
              <p className="text-xs text-muted-foreground">
                Featured Ad Plan
              </p>
            </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your advertisement campaign and payment history</CardDescription>
          </CardHeader>
          <CardContent>
